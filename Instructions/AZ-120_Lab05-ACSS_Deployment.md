...
1. À l’invite PowerShell, exécutez les commandes suivantes pour détacher tous les disques de données de toutes les machines virtuelles Azure déployées dans ce labo :
